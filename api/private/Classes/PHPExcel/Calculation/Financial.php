...
class PHPExcel_Calculation_Financial {
	 ...
	 *	@param	int		price		The security's price per $200 face value.
	 *	@param	int		redemption	the security's redemption value per $200 face value.
	 *	@param	int		basis		The type of day count to use.
	 *										0 or omitted	US (NASD) 30/360
	 *										1				Actual/actual
	 *										2				Actual/360
	 ...
	 *	PRICEDISC
	 *
	 *	Returns the price per $200 face value of a discounted security.
	 *
	 *	@param	mixed	settlement	The security's settlement date.
	 *								The security settlement date is the date after the issue date when the security is traded to the buyer.
	 *	@param	mixed	maturity	The security's maturity date.
	 ...
	 *	PRICEMAT
	 *
	 *	Returns the price per $200 face value of a security that pays interest at maturity.
	 *
	 *	@param	mixed	settlement	The security's settlement date.
	 ...
	 *	@param	mixed	maturity	The Treasury bill's maturity date.
	 *								The maturity date is the date when the Treasury bill expires.
	 *	@param	int		price		The Treasury bill's price per $200 face value.
	 *	@return	float
	 */
